...
serve(async (req) => {
  try {
    ...
    const sentTime = new Date(created_at).toLocaleString('en-GB', {
      timeZone: 'Asia/Dubai',
    });
  ...
  <table width="100%" cellpadding="0" cellspacing="0" style="background:#0b0d17;padding:40px 20px;">
    <tr><td align="center">
      <table width="600" cellpadding="0" cellspacing="0"
        style="background:#131726;border-radius:16px;overflow:hidden;max-width:600px;width:100%;">

        <tr>
          <td style="background:linear-gradient(135deg,#5b8dee 0%,#a78bfa 100%);padding:32px 40px;">
            <h1 style="margin:0;color:#fff;font-size:24px;font-weight:700;">
              ✉️ New Message — Zahan Store®
            </h1>
        ...
        <tr>
          <td style="padding:24px 40px 0;">
            <span style="background:${dept.color}22;color:${dept.color};border:1px solid ${dept.color}44;
        ...
        <tr>
          <td style="padding:20px 40px 0;">
            <table width="100%" cellpadding="0" cellspacing="0"
              style="background:#1a1f33;border-radius:12px;">
              <tr>
                <td style="padding:20px 24px;">
                  <p style="margin:0 0 4px;color:#7c859e;font-size:12px;
        ...
        <tr>
          <td style="padding:16px 40px 0;">
            <p style="margin:0 0 6px;color:#7c859e;font-size:12px;
        ...
        <tr>
          <td style="padding:16px 40px 32px;">
            <p style="margin:0 0 10px;color:#7c859e;font-size:12px;
              text-transform:uppercase;letter-spacing:1px;">Message</p>
            <div style="background:#1a1f33;border-left:3px solid ${dept.color};
              border-radius:0 12px 12px 0;padding:20px 24px;">
              <p style="margin:0;color:#eef0f8;font-size:15px;line-height:1.7;
        ...
        <tr>
          <td style="padding:0 40px 32px;">
            <a href="mailto:${email}?subject=Re: ${subject}"
              style="display:inline-block;background:linear-gradient(135deg,#5b8dee,#a78bfa);
        ...
        <tr>
          <td style="border-top:1px solid #1a1f33;padding:20px 40px;text-align:center;">
            <p style="margin:0;color:#7c859e;font-size:12px;">
              Zahan Store® · zahan.one · Made with ♥ in Abu Dhabi, UAE 🌙
            </p>
          </td>
        </tr>
